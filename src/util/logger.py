...
class Logger:
    def __init__(self, parent, taskmanager, config, name="RCJASS-Logger", level=logging.DEBUG):
        self.parent = parent
        self.config = config
        logging.basicConfig(filename="Logging/log.txt", filemode="w", format=self.config.getString("LoggingFormat"))
        ...
        self.logNoTag(logging.INFO, "\n\n\n\n\n==========["+self.config.getString("Name").replace('"', "")+"]==========\n")
